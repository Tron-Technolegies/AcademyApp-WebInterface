...
export default function LeaderboardTop3({ page }) {
  return (
    <div className="flex items-end w-full my-16 font-plus ">
      <div
        className={`bg-[#EBCEFF] p-5 rounded-l-xl w-full ${page ? "h-50" : "h-30"}  flex flex-col justify-center items-center shadow-sm relative`}
      >
      ...
      <div
        className={`bg-[#E4BDFF] p-5 w-full rounded-t-4xl ${page ? "h-65" : "h-45"}  flex flex-col justify-center items-center shadow-md relative`}
      >
      ...
      <div
        className={`bg-[#EBCEFF] p-5 rounded-r-xl w-full ${page ? "h-50" : "h-30"}  flex flex-col justify-center items-center shadow-sm relative`}
      >
